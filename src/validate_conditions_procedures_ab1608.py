...
SCREENSHOT_PATH = Path("powerbi/screenshots/conditions_procedures.png")
...
def main() -> int:
    ...
    if failures:
        print("FAIL: Conditions and Procedures dashboard screenshot validation failed.")
        for failure in failures:
            print(f"- {failure}")
        return 1

    print("PASS: powerbi/screenshots/conditions_procedures.png exists and satisfies AB#1606 acceptance criteria.")
    ...
    print("Validated committed artifact path for Conditions and Procedures dashboard screenshot.")
    return 0
