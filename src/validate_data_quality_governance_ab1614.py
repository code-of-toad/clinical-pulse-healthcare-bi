...
SCREENSHOT_PATH = Path("powerbi/screenshots/data_quality_governance.png")
...
def main() -> int:
    ...
    if failures:
        print("FAIL: Data Quality and Governance dashboard screenshot validation failed.")
        for failure in failures:
            print(f"- {failure}")
        return 1

    print("PASS: powerbi/screenshots/data_quality_governance.png exists and satisfies AB#1612 acceptance criteria.")
    ...
    print("Validated committed artifact path for Data Quality and Governance dashboard screenshot.")
    return 0
