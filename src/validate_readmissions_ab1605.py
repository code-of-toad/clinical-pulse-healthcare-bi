...
SCREENSHOT_PATH = Path("powerbi/screenshots/readmissions.png")
...
def main() -> int:
    ...
    if failures:
        print("FAIL: Readmissions dashboard screenshot validation failed.")
        for failure in failures:
            print(f"- {failure}")
        return 1

    print("PASS: powerbi/screenshots/readmissions.png exists and satisfies AB#1603 acceptance criteria.")
    ...
    print("Validated committed artifact path for Readmissions dashboard screenshot.")
    return 0
